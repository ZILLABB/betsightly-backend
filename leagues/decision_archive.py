...
def _compact_candidate(pick: dict) -> dict:
    ...
    return {
        ...
        "football_first_probability": pick.get("football_first_probability"),
        "football_first_model_version": pick.get("football_first_model_version"),
        "football_first_uncertainty": pick.get("football_first_uncertainty"),
        "prediction_model_version": pick.get("prediction_model_version"),
        "ranking_policy_version": pick.get("ranking_policy_version"),
        "market_policy_version": pick.get("market_policy_version"),
        "source_freshness": pick.get("source_freshness"),
        ...
        "alternatives_rejected": list(pick.get("alternatives_rejected") or []),
