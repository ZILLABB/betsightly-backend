...
This script optimizes the prediction categories to focus on safe bets with high confidence
and ensures each team appears only once across all categories.
"""
...
def optimize_safe_bets():
    """Optimize the prediction categories to focus on safe bets with high confidence."""
    ...
    try:
        ...
        logger.info("Safe bets optimization completed successfully")
    
    except Exception as e:
        logger.error(f"Error optimizing safe bets: {str(e)}")
        import traceback
