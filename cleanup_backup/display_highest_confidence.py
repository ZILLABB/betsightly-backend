"""
Display Highest Confidence Predictions

This script displays the optimized predictions where each match appears exactly once
with its highest-confidence prediction.
"""
...
def display_highest_confidence():
    """Display the optimized predictions with highest confidence."""
    ...
    try:
        ...
        print("\n" + "="*80)
        print(f"OPTIMIZED PREDICTIONS WITH HIGHEST CONFIDENCE")
        print("="*80)
        ...
        # Print summary
        print("\n" + "="*80)
        print("SUMMARY OF OPTIMIZED PREDICTIONS")
        print("="*80)
        ...
        logger.error(f"Error displaying highest confidence: {str(e)}")
        import traceback
