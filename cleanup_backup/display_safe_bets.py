...
This script displays the optimized safe bets with high confidence and unique teams.
"""
...
def display_safe_bets():
    """Display the optimized safe bets."""
    ...
    try:
        ...
        print("\n" + "="*80)
        print(f"OPTIMIZED SAFE BETS WITH HIGH CONFIDENCE")
        print("="*80)
        ...
        for category, name in categories.items():
            ...
            # Track teams to check for duplicates
            teams = set()
            ...
            for pred in best_combo.predictions:
                ...
                if fixture:
                    ...
                    if home_team in teams or away_team in teams:
                        print(f"      WARNING: Duplicate team detected!")
        ...
        # Print summary
        print("\n" + "="*80)
        print("SUMMARY OF OPTIMIZED SAFE BETS")
        print("="*80)
        ...
        logger.error(f"Error displaying safe bets: {str(e)}")
        import traceback
